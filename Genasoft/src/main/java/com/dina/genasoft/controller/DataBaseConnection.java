...
public class DataBaseConnection {
    ...
    @Value("${db.base.source}")
    private String     ssource   = "jdbc:mysql://81.45.93.193:3306/db_brostel";
    @Value("${db.base.user}")
    private String     suser     = "dani";
    private String     spassword = "LbB_B#qj";
    @Value("${db.base.driverclassname}")
     ...
     */
    public DataBaseConnection() throws GenasoftException {
