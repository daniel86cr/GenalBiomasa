...
@Theme("Genal")
@UIScope
@SpringView(name = VistaLibroTrazabilidad.NAME)
public class VistaLibroTrazabilidad extends CustomComponent implements View ,Button.ClickListener {
    /** El nombre de la vista.*/
    public static final String                        NAME                     = "vLibroTrazabilidad";
            ...
            try {
                ...
                for (Date key : lFechas) {
                    ...
                    for (TVentasVista res : lAux2) {
                        if (res.getKgsFin().equals(Double.valueOf(0))) {
                            continue;
                        }
                        lVentas.add(res);
                    }
    ...
    private void crearTablaComprasCambios(TPermisos permisos) {
        tablaComprasCambios = new TablaGenerica(new Object[] { "albaranFin", "fechaFin", "partidaFin", "pesoNetoFin", "cajasFin", "kgsBrutoFin", "loteFin", "variedadFin", "proveedorFin", "origenFin", "familiaFin", "ggnFin", "calidadFin", "calibreFin" }, new String[] { "Albarán", "Fecha", "Partida", "Peso neto", "Nº de cajas", "Peso bruto", "Trazabilidad", "Variedad", "Entidad", "Orígen", "Plantilla de producto", "Global Gap", "Calidad", "Calibre" }, bcCompras);
    ...
    private void crearTablaLineasVentas() {
        tablaLineasVentas = new TablaGenerica(new Object[] { "certificacionFin", "ggn", "kgsTrazadosFin", "loteFin", "referenciaCompraFin", "proveedorFin", "albaranCompraFin" }, new String[] { "Certificación", "GGN", "Kgs", "Lote", "Referencia compra", "Proveedor", "Albarán compra" }, bcLineasVentas);
    ...
    private void crearTablaVentasCambios(TPermisos permisos) {
        tablaVentasCambios = new TablaGenerica(new Object[] { "pedidoFin", "albaranFin", "lineaPedido", "calibreFin", "idPaleFin", "loteMovAlmFi", "clienteFin", "fechaVentaFin", "kgsNetosFin", "kgsEnvaseFin", "variedadFin", "origenFin", "calidadVentaFin", "confeccionFin", "familiaFin" }, new String[] { "Pedido de venta", "Albarán de venta", "Línea pedido", "Calibre", "Cód. Pallet", "Trazabilidad Pallet", "Cliente", "Fecha", "Kilos", "Kilos envase", "Variedad", "Orígen venta", "Certificación", "Confección", "Producto" }, bcVentas);
        ...
        try {
            ...
            for (List<TVentasVista> lista : lValues) {
                ...
                for (TVentasVista venta : lista) {
                    if (venta.getKgsNetosFin().equals(Double.valueOf(0))) {
                        continue;
                    }
                    lVentas.add(venta);
                }
    ...
    private void comprobarFiltrosAplicados() {
        ...
        if (filtr.equals("Filtros: ")) {
            ...
            filter = new FiltroContainer("variedadFin", "ollolololololo", status);
            bcCompras.addContainerFilter(filter);
            bcVentas.addContainerFilter(filter);
