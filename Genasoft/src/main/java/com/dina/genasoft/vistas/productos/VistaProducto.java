...
@Theme("Genal")
@UIScope
@SpringView(name = VistaProducto.NAME)
public class VistaProducto extends CustomComponent implements View ,Button.ClickListener {
    ...
    private static final org.slf4j.Logger log      = org.slf4j.LoggerFactory.getLogger(VistaProducto.class);
        ...
        if (time != null) {
            try {
                ...
                if (empNuevo == null) {
                    ...
                    aviso.setPosition(Position.MIDDLE_CENTER);
                    aviso.show(Page.getCurrent());
                    getUI().getNavigator().navigateTo(VistaListadoProductos.NAME);
                    return;
                }
