...
@Theme("Genal")
@UIScope
@SpringView(name = VistaNuevoTransportista.NAME)
public class VistaNuevoTransportista extends CustomComponent implements View ,Button.ClickListener {
    /** El controlador de las vistas. */
    @Autowired
    private ControladorVistas               contrVista;
    /** El nombre de la vista.*/
    public static final String              NAME     = "nuevoTransportista";
    ...
    private static final org.slf4j.Logger   log      = org.slf4j.LoggerFactory.getLogger(VistaNuevoTransportista.class);
