...
@Theme("Genal")
@UIScope
@SpringView(name = VistaNuevoControlPt.NAME)
public class VistaNuevoControlPt extends CustomComponent implements View ,Button.ClickListener {
    /** El controlador de las vistas. */
    @Autowired
    private ControladorVistas                           contrVista;
    /** El nombre de la vista.*/
    public static final String                          NAME                       = "nuevoControlPt";
    ...
    private static final org.slf4j.Logger               log                        = LoggerFactory.getLogger(VistaNuevoControlPt.class);
    /** El pedido. */
    ...
    private void crearComponentes() {
        ...
        */
        ...
        txtOrigen.setWidth(7, Sizeable.Unit.EM);
    ...
    private void accionCrearControlPt() {
        ...
        try {
            ...
            if (validaDatosLineas()) {
                ...
                if (!text.isEmpty()) {
                    text = text + "¿Quieres continuar con la creación?";
    ...
    private void accionCrear() {
        try {
            ...
            if (result.equals(Constants.OPERACION_OK)) {
                ...
                getUI().getNavigator().navigateTo(VistaControlPt.NAME + "/" + nControlPt.getId() + "_1");
