...
public class AlbaranPDF extends PdfPageEventHelper {
    ...
    public void createPdf(String numAlbaran, String nombre) throws IOException, DocumentException, GenasoftException {
        ...
        lLineas = importadorSetup.obtenerTodasLineasVentaAlbaran(numAlbaran);
    ...
    public PdfPTable crearTablaCabecera2(PdfWriter writer) throws IOException, GenasoftException, DocumentException {
        ...
        try {
            ...
            cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
            table.addCell(cell);
            cell = new PdfPCell(new Phrase("Kilos", cabecera2));
            cell.setBackgroundColor(myColor);
            cell.setBorder(PdfPCell.NO_BORDER);
            cell.setCellEvent(new CustomBorder(solid, solid, solid, solid));
            cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
            ...
            String bio = "BIO";
            for (TVentasVista linea : lLineas) {
                bio = "";
                ...
                table.addCell(cell);
                // MARCA.
                cell = new PdfPCell(new Phrase(linea.getMarcaFin(), fLinea2));
                cell.setBorder(PdfPCell.NO_BORDER);
                cell.setCellEvent(new CustomBorder(solid, solid, solid, solid));
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                ...
                table.addCell(cell);
                // UNIDADES.
                cell = new PdfPCell(new Phrase(df.format(linea.getKgsNetosFin()), fLinea));
                cell.setBorder(PdfPCell.NO_BORDER);
                cell.setCellEvent(new CustomBorder(solid, solid, solid, solid));
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
