...
public class TrazabilidadesExcel extends AbstractXlsView {
    ...
    protected void buildExcelDocument(Map<String, Object> model, Workbook workbook, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        lCompras = (List<TCompras>) model.get("compras");
        lVentas = (List<TVentas>) model.get("ventas");
        lLineas = (List<TLineasVentas>) model.get("lineas");
        ...
        sheet.setColumnWidth(9, 980 * (74 / 7));
        ...
        sheet.setColumnWidth(32, 580 * (74 / 7));
        sheet.setColumnWidth(33, 580 * (74 / 7));
        sheet.setColumnWidth(34, 580 * (74 / 7));
        sheet.setColumnWidth(35, 580 * (74 / 7));
        sheet.setColumnWidth(36, 580 * (74 / 7));
        sheet.setColumnWidth(37, 580 * (74 / 7));
        ...
        if (!lVentas.isEmpty()) {
            // Pintamos la cabecera de la tabla
            Integer column = crearCabeceraTablaVentas(workbook, sheet, currentRow, currentColumn);

            crearCabeceraTablaLineasVentas(workbook, sheet, currentRow, column);
        }
        currentRow++;
        ...
        // Rellenamos la tabla de contenido
        rellenarTablaDatosLineasVentas(workbook, sheet, currentRow);
     ...
     * @param sheet La hoja.
     */
    private int crearCabeceraTablaVentas(Workbook workbook, Sheet sheet, int currentRow, int currentColumn) {
     ...
     * @param sheet La hoja.
     */
    private void crearCabeceraTablaLineasVentas(Workbook workbook, Sheet sheet, int currentRow, int currentColumn) {
        ...
        text = new HSSFRichTextString("Kgs");
        cell2 = headerRow.createCell(currentColumn);
        cell2.setCellStyle(estiloCeldaCabecera);
        cell2.setCellValue(text);
        currentColumn++;

        text = new HSSFRichTextString("Trazabilidad");
        cell2 = headerRow.createCell(currentColumn);
        cell2.setCellStyle(estiloCeldaCabecera);
        cell2.setCellValue(text);
        currentColumn++;

        text = new HSSFRichTextString("Referencia compra");
        cell2 = headerRow.createCell(currentColumn);
        cell2.setCellStyle(estiloCeldaCabecera);
        cell2.setCellValue(text);
        currentColumn++;

        text = new HSSFRichTextString("Proveedor");
        cell2 = headerRow.createCell(currentColumn);
        cell2.setCellStyle(estiloCeldaCabecera);
        cell2.setCellValue(text);
        currentColumn++;
     ...
     * Método que nos rellena la tabla de datos.
     */
    private void rellenarTablaDatosLineasVentas(Workbook workbook, Sheet sheet, Integer currentRow) {
        ...
        for (TLineasVentas linea : lLineas) {
            ...
            // CALIDAD
            text = new HSSFRichTextString(linea.getCertificacionFin());
            cell2 = headerRow.createCell(currentColumn);
            cell2.setCellStyle(estiloContenidoTabla);
            cell2.setCellValue(text);
            CellUtil.setAlignment(cell2, workbook, CellStyle.ALIGN_CENTER);
            ...
            // GGN
            text = new HSSFRichTextString(linea.getGgn());
            cell2 = headerRow.createCell(currentColumn);
            cell2.setCellStyle(estiloContenidoTabla);
            cell2.setCellValue(text);
            CellUtil.setAlignment(cell2, workbook, CellStyle.ALIGN_CENTER);
            ...
            // KGS
            text = new HSSFRichTextString("" + linea.getKgsTrazabilidadFin());
            cell2 = headerRow.createCell(currentColumn);
            cell2.setCellStyle(estiloContenidoTabla);
            cell2.setCellValue(text);
            CellUtil.setAlignment(cell2, workbook, CellStyle.ALIGN_CENTER);
            ...
            // LOTE
            text = new HSSFRichTextString(linea.getLoteFin());
            cell2 = headerRow.createCell(currentColumn);
            cell2.setCellStyle(estiloContenidoTabla);
            cell2.setCellValue(text);
            CellUtil.setAlignment(cell2, workbook, CellStyle.ALIGN_CENTER);
            ...
            // REF COMPRA
            text = new HSSFRichTextString(linea.getReferenciaCompraFin());
            cell2 = headerRow.createCell(currentColumn);
            cell2.setCellStyle(estiloContenidoTabla);
            cell2.setCellValue(text);
            CellUtil.setAlignment(cell2, workbook, CellStyle.ALIGN_CENTER);
            ...
            // PROVEEDOR
            text = new HSSFRichTextString(linea.getProveedorFin());
            cell2 = headerRow.createCell(currentColumn);
            cell2.setCellStyle(estiloContenidoTabla);
            cell2.setCellValue(text);
            CellUtil.setAlignment(cell2, workbook, CellStyle.ALIGN_CENTER);
            ...
            // ALBARÁN COMPRA
            text = new HSSFRichTextString(linea.getAlbaranCompraFin());
            cell2 = headerRow.createCell(currentColumn);
            cell2.setCellStyle(estiloContenidoTabla);
            cell2.setCellValue(text);
            CellUtil.setAlignment(cell2, workbook, CellStyle.ALIGN_CENTER);
     ...
     */
    private String obtenerDatoMostrarCompra(TCompras compra, String campo) {
        String result = null;
     ...
     * @return El valor del campo
     */
    private String obtenerDatoMostrarVenta(TVentas venta, String campo) {
        String result = null;
    ...
    private void crearTotalesVentas(Workbook workbook, Sheet sheet, int currentRow) {
        ...
        // El nombre del transportista
        HSSFRichTextString text = new HSSFRichTextString("Movimientos ventas");
        Cell cell = headerRow.createCell(currentColumn);
        cell.setCellStyle(estiloCeldaCabecera);
        cell.setCellValue(text);
        CellUtil.setAlignment(cell, workbook, CellStyle.ALIGN_CENTER);
        ...
        */
        ...
        // El nombre del transportista
        text = new HSSFRichTextString("Trazabilidades");
        cell = headerRow.createCell(currentColumn);
        cell.setCellStyle(estiloCeldaCabecera);
        cell.setCellValue(text);
        CellUtil.setAlignment(cell, workbook, CellStyle.ALIGN_CENTER);

        CellRangeAddress regionTitulo2 = null;

        if (!lCompras.isEmpty()) {
            // ORDEN DE TRANSPORTE
            regionTitulo = CellRangeAddress.valueOf("AC8:AC8");
        } else {
            regionTitulo = CellRangeAddress.valueOf("AC8:AC8");
        }
