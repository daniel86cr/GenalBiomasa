...
@Slf4j
@Data
public class FacturaPDF extends PdfPageEventHelper {
    /** El log de la aplicación*/
    private static final org.slf4j.Logger log        = org.slf4j.LoggerFactory.getLogger(FacturaPDF.class);
    ...
    /** La factura que se va a exportar a PDF.*/
    ...
    /** Listado de líneas que componen la factura. */
    private List<TLineasFacturaVista>     lLineas;
    ...
    /** El pesaje de la factura. */
    private TPesajes                      pesajes;
     ...
     */
    public void createPdf(int idPedido, String nombre, String pathLogo, Boolean cabecera) throws IOException, DocumentException, GenasoftException {
        ...
        factura = facturasSetup.obtenerFacturaPorId(idPedido);

        if (factura != null) {

            lLineas = facturasSetup.obtenerLineasFacturaPorIdFacturaVista(factura.getId());

            cliente = clientesSetup.obtenerClientePorId(factura.getIdCliente());
    ...
    public PdfPTable crearTablaEmpresa() throws IOException, GenasoftException {
        ...
        try {
            ...
            empresa = empresasSetup.obtenerEmpresaPorId(factura.getEmpresa());
    ...
    public PdfPTable crearTablaConsignatario() throws IOException, GenasoftException {
        ...
        try {
            ...
            TDireccionCliente dir = clientesSetup.obtenerDireccionClientePorId(factura.getIdDireccion());
    ...
    public PdfPTable crearTablaCabecera1(PdfWriter writer) throws IOException, GenasoftException {
        ...
        try {
            ...
            // Datos
            String numFactura = factura.getNumeroFactura();
            ...
            cell.setCellEvent(new CustomBorder(null, null, null, null));
            table.addCell(cell);
            cell = new PdfPCell(new Phrase(new SimpleDateFormat("dd/MM/yyyy").format(factura.getFechaFactura()), cabecera));
            cell.setBorder(PdfPCell.NO_BORDER);
            cell.setHorizontalAlignment(Element.ALIGN_CENTER);
            cell.setCellEvent(new CustomBorder(null, null, null, null));
            table.addCell(cell);
